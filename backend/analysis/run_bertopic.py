...
Do NOT start the label with the word "cluster" (case-insensitive) or with any phrase that begins with it — for example: "Cluster Summary:", "Cluster Overview:", "Cluster Title:", "Cluster Of", or "Cluster: ". It's acceptable if the word "cluster" appears at the end of the label.
